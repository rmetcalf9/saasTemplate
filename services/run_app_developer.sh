...
export APIAPP_OBJECTSTORECONFIG="{\"Type\": \"Caching\", \"DefaultPolicy\": { \"cache\": true, \"maxCacheSize\": 50, \"cullToSize\": 40, \"timeout\": 1000 }, \"ObjectTypeOverride\": {}, \"Main\": {\"Type\": \"SimpleFileStore\",\"BaseLocation\": \"./objectstoredata\"}}"
